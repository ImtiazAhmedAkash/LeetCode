...
| 300 | Longest Increasing Subsequence | 🟡 | [Link](https://leetcode.com/problems/longest-increasing-subsequence/) | [C++](solutions/300_LongestIncreasingSubsequence.cpp) | `Array` `DP` `Binary Search` | Patience Sorting (LIS Optimization) |
