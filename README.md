...
| 57 | Insert Interval | 🟡 | https://leetcode.com/problems/insert-interval/ | solutions/57_InsertInterval.cpp | `Array` `Intervals` `Simulation` | Three-Phase Interval Merge |
...
| 268 | Missing Number | 🟢 | [Link](https://leetcode.com/problems/missing-number/) | [C++](solutions/268_MissingNumber.cpp) | `BitManipulation` `Math` | XOR Cancellation Trick |
...
| 300 | Longest Increasing Subsequence | 🟡 | [Link](https://leetcode.com/problems/longest-increasing-subsequence/) | [C++](solutions/300_LongestIncreasingSubsequence.cpp) | `Array` `DP` `BinarySearch` | Patience Sorting (LIS Optimization) |
